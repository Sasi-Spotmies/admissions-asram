      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-bold font-serif text-gray-900 tracking-tight mb-2">Frequently Asked Questions</h2>
            <p className="text-base text-gray-600 max-w-xl mx-auto">Find answers to common questions about admissions and requirements</p>
          </div>
          ...
          <div className="space-y-3">
            {faqs.map((f, index) => (
              <div key={f.q} className="group relative">
                ...
                <details className="relative z-10 rounded-xl border border-gray-200/60 bg-white/90 backdrop-blur-lg shadow-md hover:shadow-lg transition-all duration-300 group-open:shadow-lg">
                  <summary className="cursor-pointer list-none p-4 flex items-start justify-between gap-4 hover:bg-gray-50/50 rounded-xl transition-colors duration-200">
                    <div className="flex items-start gap-3">
                      ...
                      <span className="text-base md:text-lg font-semibold text-gray-900 leading-relaxed">{f.q}</span>
                    </div>
                  ...
                  <div className="px-4 pb-4 pt-1">
                    <div className="ml-9">
                      <div className="text-sm md:text-base text-gray-700 leading-relaxed bg-amber-50 rounded-lg p-3 border border-amber-100">
                        {f.a}
                      </div>
                    </div>
                  </div>
